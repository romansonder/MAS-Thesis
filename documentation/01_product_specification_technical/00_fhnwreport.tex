...
\title{
	\textsc{\LARGE{Projektplan}}\\[10mm]
	\textsc{\LARGE{MAS-Thesis Operational Identification}}
}
...
Auftraggeber	\> Paul Baumann \\[5mm]
Fachcoach		\> Fernando Benites\\[5mm]
Student	\> Roman Sonder\\[5mm]
Weiterbildung	\> MAS Data Science \\[5mm]
\end{tabbing}
}
...
Der Studierende Roman Sonder, in der Weiterbildung Master of Advanced Studies Data Science, wird von Fernando Benites einem Fachcoach der Fachhochschule Nordwestschweiz (FHNW) betreut. Paul Baumann, Product Manager Teamleiter, betreuut das Projekt von Seite Siemens Schweiz AG.


\begin{figure}[htb]
\includegraphics[width=\textwidth]{0_Organigramm.png}
\caption{Organigramm} % picture caption
